...
public class LeafrimMoveState : State
{
    ...
    public LeafrimMoveState(Entity entity, StateMachine stateMachine, string animBoolName, Enemy_Leafrim enemy) : base(entity, stateMachine, animBoolName)
    {
        this.enemy = enemy;
    }
